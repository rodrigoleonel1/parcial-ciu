      ...
      <section className="relative h-[90vh] min-h-[500px] flex items-center overflow-hidden">
        <div className="absolute inset-0">
          <img
            ...
            src="https://i.pinimg.com/474x/3a/1c/b4/3a1cb4c23e47b7c98390cdfef88a2db3.jpg"
            alt="Colección de accesorios"
          />
          <div className="absolute inset-0 bg-gray-900 opacity-80 backdrop-blur-lg"></div>
        </div>
        ...
        <div className="relative mx-auto flex flex-col gap-8 px-16">
          ...
          <p className="text-lg sm:text-xl text-gray-300 max-w-lg -mt-4">
