        ...
        <div className="rounded-lg p-4 mb-6 flex flex-col items-center gap-2 text-white hover:border-cyan-400 transition-all">
          {carritoAux.length === 0 ? (
            <div className="bg-linear-to-b from-cyan-950/10 via-gray-950 to-gray-950 py-20  shadow rounded-lg p-8 text-center">
              <p className="text-white-500 text-lg">¡Tu carrito está vacío! <br />Prueba añadiendo unas cosas...</p>
            </div>
          ) : (
          ...
          <button className="bg-gray-700 text-white px-5 py-2 text-xs sm:px-3 sm:py-2 sm:text-sm rounded hover:bg-blue-600 hover:cursor-pointer transition-colors m-2" onClick={() => navigate(-1)}>
            Volver
          </button>
