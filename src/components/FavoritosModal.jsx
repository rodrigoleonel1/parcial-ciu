...
export default function FavoritosModal({ onClose }) {
  ...
  "
      >
        <button onClick={onClose} className="mb-4 text-xl hover:cursor-pointer">
          <X />
        </button>
        ...
        {favoritos.length === 0 ? (
          ...
          <div className="space-y-4">
            ...
            <button
              className="px-3 py-2 rounded transition-colors bg-cyan-400 text-black hover:bg-cyan-400 hover:cursor-pointer uppercase font-bold font-display"
              onClick={() => vaciar()}
            >
              Vaciar
            </button>
