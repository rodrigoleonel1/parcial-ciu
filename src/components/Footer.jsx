...
export default function Footer() {
  return (
    <footer className="bg-gray-950/95 backdrop-blur border-t border-gray-800">
      <div className="max-w-7xl mx-auto py-8 px-4 sm:px-6 lg:px-8 grid grid-cols-1 sm:grid-cols-3 gap-6 gap-8">
        <article className="mx-auto">
          ...
          <p className="tracking-wider text-sm text-gray-300 max-w-3/4">
        ...
        <article className="mx-auto">
          ...
          <nav className="flex flex-col gap-2">
            <NavLink
              to="/"
              className="tracking-wider text-sm transition-colors text-gray-300 hover:text-cyan-400"
            >
              Inicio
            </NavLink>
            <NavLink
