  ...
  return (
    <div>
      ...
      <div className="flex justify-between mt-4">
        {producto.stock > 0 ? (
          <button
            className="bg-blue-500 text-white px-3 py-2 rounded hover:bg-blue-700 hover:cursor-pointer transition-colors"
          ...
          <button
            className="bg-red-700 text-white px-3 py-2 rounded hover:bg-red-800 transition-colors disabled:opacity-50
